...
this.options=e.extend({className:"placeholder",visibleToScreenreaders:true,visibleToScreenreadersHideClass:"placeholder-hide-exept-screenreader",visibleToNoneHideClass:"placeholder-hide",hideOnFocus:true,removeLabelClass:"visuallyhidden",hiddenOverrideClass:"visuallyhidden-with-placeholder",forceHiddenOverride:true},k);
...
if(!n){d("the input element with the placeholder needs a label!");return;}if(e(n).hasClass(l.options.removeLabelClass)){e(n).removeClass(l.options.removeLabelClass).addClass(l.options.hiddenOverrideClass);
...
}else{f(m,l.options);}});m.focusout(function(){b(e(this),l.options);if(!l.options.hideOnFocus&&window.cancelAnimationFrame){j();}});b(m,l.options);e(document).bind("fontresize resize",function(){g(p,m);
