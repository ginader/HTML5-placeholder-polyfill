...
if(!i){d("the input element with the placeholder needs a label!");return;}if(e(i).hasClass("visuallyhidden")){e(i).removeClass("visuallyhidden").addClass("visuallyhidden-with-placeholder");
}k=e('<span class="'+g.options.className+'">'+l+"</span>").appendTo(i);j=(k.width()>h.width());if(j){k.attr("title",l);}a(k,h);h.data("placeholder",k);
k.data("input",k);k.click(function(){e(this).data("input").focus();});h.focusin(function(){e(this).data("placeholder").addClass(g.options.hideClass);});
